...
Read relevant project instructions before doing anything else. This is a mandatory step, not a suggestion. The instructions contain the coding standards and Context7 usage rules that govern how you resolve review comments. The `babysit-pr` skill calls out *when* to apply these standards and *which* libraries require Context7 — this instruction file defines *how* to execute those steps.
