...
| §12 Prompt Construction and Context Assembly          | Changing prompt rendering, FuncMap, or context fields supplied to the template (including the between-turn `.new_comments` steering variable) |
